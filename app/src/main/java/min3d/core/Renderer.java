...
//import com.paradigmcreatives.percipi.ExampleLoadObjFile;
//import com.paradigmcreatives.percipi.Page;
...
public class Renderer implements GLSurfaceView.Renderer
{
	...
	public void onDrawFrame(GL10 gl)
	{
		...
		// Update 'model'
		//System.out.println("z value is +"+Page.z);
		// Update 'view'
		drawSetup();
		drawScene();
		//gl.glTranslatef(0.0f, 0.0f, -RendererActivity.z);	//Move down 1.2 Unit And Into The Screen 6.0
		//gl.glRotatef(RendererActivity.xrot, 1.0f, 0.0f, 0.0f);	//X
		//gl.glRotatef(RendererActivity.yrot, 0.0f, 0.0f, 1.0f);	//Y
	...
	protected void drawSetup()
	{
		...
		/*GLU.gluLookAt(_gl, 
				RendererActivity.xrot,RendererActivity.xrot,RendererActivity.z,
			_scene.camera().target.x,_scene.camera().target.y,_scene.camera().target.z,
			_scene.camera().upAxis.x,_scene.camera().upAxis.y,_scene.camera().upAxis.z);
		*/
		// Background color
	...
	protected void drawObject(Object3d $o)
	{
		...
		*/
		...
		//_gl.glRotatef(RendererActivity.xrot, 1,0,0);
		//_gl.glRotatef(RendererActivity.yrot, 0,1,0);
